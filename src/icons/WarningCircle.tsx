...
const Broken: VFC<BrokenProps> = (props) => (
    <G>
        ...
        <Path d="M12 16.99V17" stroke={props.color} strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        <Path d="M12 7L12 14" stroke={props.color} strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    </G>
);
...
const WarningCircle: VFC<WarningCircleProps> = (props) => {
