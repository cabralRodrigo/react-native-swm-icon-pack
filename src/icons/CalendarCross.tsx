...
const Broken: VFC<BrokenProps> = (props) => (
    <G>
        <Path d="M20 14L13 21" stroke={props.strokeColor} stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
        <Path d="M13 14L20 21" stroke={props.strokeColor} stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
        <Path d="M4 11L9 11" stroke={props.strokeColor} stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
...
const CalendarCross: VFC<CalendarCrossProps> = (props) => {
