...
const Broken: VFC<BrokenProps> = (props) => (
    <G>
        ...
        <Path d="M8 15H16" stroke={props.strokeColor} stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
...
const EmoteNormal: VFC<EmoteNormalProps> = (props) => {
