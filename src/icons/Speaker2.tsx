...
const Broken: VFC<BrokenProps> = (props) => (
    <G>
        ...
        <Path d="M16 8.99998C16.5 9.49999 17 10.5 17 12C17 13.5 16.5 14.5 16 15" stroke={props.strokeColor} stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
        <Path d="M19 6C20.5 7.5 21 10 21 12M19 18C19.794 17.206 20.3078 16.1319 20.6155 15" stroke={props.strokeColor} stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
    </G>
);

const Curved: VFC<CurvedProps> = (props) => (
    <G>
        <Path d="M19 6C20.5 7.5 21 10 21 12C21 14 20.5 16.5 19 18" stroke={props.strokeColor} stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
