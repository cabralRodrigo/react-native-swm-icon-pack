...
const Curved: VFC<CurvedProps> = (props) => (
    <G>
        <Path d="M12 3C9 3 7.5 7.5 5.5 8C3.5 8.5 3 9.39543 3 10.5V13.5C3 14.6046 3.5 15.5 5.5 16C7.5 16.5 9 21 12 21C14 21 14 3 12 3Z" stroke={props.strokeColor} stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
    </G>
);
