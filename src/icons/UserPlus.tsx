...
const Broken: VFC<BrokenProps> = (props) => (
    <G>
        <Path d="M20 8.5V13.5" stroke={props.color} strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        <Path d="M17.5 11H22.5" stroke={props.color} strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
...
const Curved: VFC<CurvedProps> = (props) => (
    <G>
        <Path d="M20 8V14" stroke={props.color} strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        <Path d="M17 11L23 11" stroke={props.color} strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
...
const UserPlus: VFC<UserPlusProps> = (props) => {
