...
const Broken: VFC<BrokenProps> = (props) => (
    <G>
        <Path d="M18.5883 16.2941L16.7059 14.4118" stroke={props.color} strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        <Path d="M12 19.1176V21H13.8824L20 14.8824L18.1176 13L12 19.1176Z" stroke={props.color} strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
...
const Curved: VFC<CurvedProps> = (props) => (
    <G>
        <Path d="M18 13L12 19V21H14L20 15L18 13Z" stroke={props.color} strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        <Path d="M16.5 14.5L18.5 16.5" stroke={props.color} strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
...
const Duotone: VFC<DuotoneProps> = (props) => (
    <G>
        <Path d="M18.5882 16.2941L16.7059 14.4118" stroke={props.color} strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        <Path d="M12 19.1176V21H13.8824L20 14.8824L18.1176 13L12 19.1176Z" stroke={props.color} strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
        <Path d="M4 11H9" stroke={props.color} strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
