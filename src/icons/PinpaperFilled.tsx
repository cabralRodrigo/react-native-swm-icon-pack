...
const Broken: VFC<BrokenProps> = (props) => (
    <G>
        <Path d="M8 17H16" stroke={props.strokeColor} stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
        <Path d="M8 13H14" stroke={props.strokeColor} stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
...
const Curved: VFC<CurvedProps> = (props) => (
    <G>
        <Path d="M9 13H13" stroke={props.strokeColor} stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
        <Path d="M9 17H15" stroke={props.strokeColor} stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
...
const PinpaperFilled: VFC<PinpaperFilledProps> = (props) => {
