...
const Broken: VFC<BrokenProps> = (props) => (
    <G>
        <Path d="M8 14V20" stroke={props.color} strokeWidth={props.strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
