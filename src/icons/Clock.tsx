...
const Broken: VFC<BrokenProps> = (props) => (
    <G>
        <Path d="M12 8V12L14 14" stroke={props.strokeColor} stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
...
const Curved: VFC<CurvedProps> = (props) => (
    <G>
        <Path d="M12 8V12L14 14" stroke={props.strokeColor} stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
        <Path d="M12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20Z" stroke={props.strokeColor} stroke-width={props.strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
    </G>
);
...
const Clock: VFC<ClockProps> = (props) => {
